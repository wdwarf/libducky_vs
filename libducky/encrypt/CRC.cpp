...
#include "stdafx.h"
#include <libducky/encrypt/CRC.h>
...
unsigned short CRC::CRC16(const unsigned char* ptr, unsigned int len) {
...
unsigned short CRC::CRC16_1(const unsigned char* ptr, unsigned int len) {
	unsigned short CRC16;
	unsigned char High_8bits;
...
unsigned short CRC::CRC16_2(const unsigned char* ptr, unsigned int len) {
	unsigned char i;
...
unsigned short CRC::CRC16_3(const unsigned char* ptr, unsigned int len) {
	unsigned short CRC_Remainder_Table[256] = { 0x0000, 0x1021, 0x2042, 0x3063,
			0x4084, 0x50a5, 0x60c6, 0x70e7, 0x8108, 0x9129, 0xa14a, 0xb16b,
			0xc18c, 0xd1ad, 0xe1ce, 0xf1ef, 0x1231, 0x0210, 0x3273, 0x2252,
			0x52b5, 0x4294, 0x72f7, 0x62d6, 0x9339, 0x8318, 0xb37b, 0xa35a,
